  ...
  const doAssert = descriptors => {
    ...
    test.deepEqual(
      [...descriptors].map(descriptor => {
        const loader = descriptor.loader.replace(/\\/g, "/");
        const _pluginPath = descriptor._pluginPath.replace(/\\/g, "/");
        Object.defineProperty(descriptor, "loader", { value: loader });
        Object.defineProperty(descriptor, "_pluginPath", {
          value: _pluginPath
        });
        return { ...descriptor, loader, _pluginPath };
      }),
      expected
    );
...
module.exports = {
  ...
  decorates(test) {
    ...
    this.manager
      ...
      .then(instance => {
        test.equals(
          instance.descriptor.loader.replace(/\\/g, "/"),
